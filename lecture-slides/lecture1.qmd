...
```stata
pctile capital_suscrito, p(25 50 75)
```
## Stata implementations

- Use the `zscore` command to calculate the $Z$-scores of a variable.

- The `zscore` command will calculate the $Z$-scores of the variable, centering the data around the mean and scaling it by the standard deviation.

```stata
zscore capital_suscrito
```
